...
class _Array
{
	...
	public function toString()
	{
		...
		foreach ( $this->_array as $key => $value)
		{
			...
			//$value =  is_object($value) ? $value->_toString() : $this->htmlEncode($value) ;
			//$html .= '<div class="'.$this->styleClass('row').'"><div class="'.$this->class('key').'">'.$this->htmlEncode($key).'</div>'.$this->arrow().'<div class="''">'.$value.'</div></div>';
